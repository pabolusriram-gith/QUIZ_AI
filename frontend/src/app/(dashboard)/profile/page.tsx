  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <motion.div
        ...
        className="glass-panel border-border shadow-[0_12px_40px_-12px_rgba(0,0,0,0.08)] dark:shadow-[0_12px_40px_-12px_rgba(0,0,0,0.25)] rounded-3xl p-6 md:p-8 space-y-8"
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pb-8 border-b border-border">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground font-medium mt-0.5">{currentUser?.email}</p>
          </div>
        </div>
        ...
        {currentUser && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-4 rounded-xl bg-black/5 dark:bg-white/3 border border-border space-y-1">
              ...
              <span className="text-sm text-foreground/80 font-semibold block pt-1">{currentUser.full_name || "Not set"}</span>
            </div>
            ...
            <div className="p-4 rounded-xl bg-black/5 dark:bg-white/3 border border-border space-y-1">
              ...
              <span className="text-sm text-foreground/80 font-semibold block pt-1">
